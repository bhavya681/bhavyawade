    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6">
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="flex gap-4 mt-6 justify-center lg:justify-start">
            <a
              ...
              aria-label="Twitter"
              className={`w-10 h-10 flex no-underline  items-center justify-center rounded-full border-2 transition-all duration-300 
        ...
        <div className="text-center lg:text-right">
          ...
          <nav className="flex gap-6 justify-center mt-4 text-sm">
            <a href="#home" className="text-white hover:underline no-underline ">
              Home
            </a>
            <a href="#projects" className="text-white hover:underline no-underline ">
              Projects
            </a>
            <a href="#about" className="text-white hover:underline no-underline ">
              About
            </a>
            <a href="#contact" className="text-white hover:underline no-underline ">
              Contact
            </a>
          </nav>
        </div>
      ...
      <div className="mt-10 text-center text-sm opacity-80">
        ...
        <div className="flex justify-center gap-6 mt-2">
          <a href="#terms" className="text-gray-300 no-underline  hover:underline">
            Terms of Use
          </a>
          <a href="#privacy" className="text-gray-300 no-underline  hover:underline">
            Privacy Policy
          </a>
        </div>
      </div>
