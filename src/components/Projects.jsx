...
import Footify from "../assets/footify.png";
import financestuff from "../assets/financestuff.png";
...
const projects = [
  ...
  },
  {
    title: "Footify",
    description:
      "a sleek, responsive React + TypeScript project with dynamic UI, built for performance and modern web excellence.",
  ...
  },
  {
    ...
    description:
      "A personal portfolio website showcasing skills and projects with a blog section using Next Js and animations.",
  ...
  },
  {
    ...
    description:
      "revolutionary crowdfunding web application designed to unite donors and causes for greater impact. 🚀[Frontend].",
  ...
  },
  {
    ...
    description:
      "a sleek and dynamic Tic Tac Toe game crafted with TypeScript and React! 🎮.",
...

  {
    ...
    description:
      "A scalable and modern e-commerce platform with advanced search [Frontend].",
...
const Projects = ({ isDarkMode }) => {
  ...
  return (
    <section
      id="projects"
      className={`min-h-screen flex flex-col items-center px-6 py-16 transition-all duration-300 ${
        ...
        {projectsToShow.map((project, index) => (
          ...
          >
            ...
            <div className="relative w-full">
              {/* Project Image */}
              <div
                className={`w-full h-64 overflow-hidden rounded-xl shadow-lg transition-transform duration-500 ${
              ...
              <div
                className={`absolute bottom-0 left-0 p-4 rounded-b-xl w-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${
              ...
              >
                ...
                <span className="block text-sm mb-2 opacity-70">
                  {project.date}
                </span>
                <a
                  href={project.link}
                  ...
                  className={`inline-block px-6 py-2 text-lg font-medium rounded-full border-2 transition-colors duration-300 ${
                    isDarkMode
      ...
      <div className="mt-12 flex justify-center items-center">
        <button
          ...
          className={`inline-block text-lg font-medium underline transition-colors duration-300 ${
            isDarkMode ? "text-primary" : "text-gray-800 hover:text-gray-600"
          }`}
        >
